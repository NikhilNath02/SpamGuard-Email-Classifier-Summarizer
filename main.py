...
# # Set up the title and some initial styling
# st.set_page_config(page_title="EmailGPT", layout="centered")
...
# # Input text area for user to enter email body
# question = st.text_area("Email Body", placeholder="Type or paste the body of your email here...")
